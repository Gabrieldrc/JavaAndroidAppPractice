...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.questionImageView = findViewById(R.id.iv_main_question_image);
        this.questionRemainingTextView = findViewById(R.id.tv_main_questions_remaining_count);
        this.submitButton = findViewById(R.id.btn_main_submit_answer);
        this.answer0Button = findViewById(R.id.btn_main_answer_0);
        this.answer1Button = findViewById(R.id.btn_main_answer_1);
        this.answer2Button = findViewById(R.id.btn_main_answer_2);
        this.answer3Button = findViewById(R.id.btn_main_answer_3);
        this.questionTextView = findViewById(R.id.tv_main_question_title);
        // TODO 4-E: set onClickListener for each answer Button
        this.answer0Button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                onAnswerSelected(0);
            }
        });
        this.answer1Button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                onAnswerSelected(1);
            }
        });
        this.answer2Button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                onAnswerSelected(2);
            }
        });
        this.answer3Button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                onAnswerSelected(3);
            }
    ...
    {
        this.questionImageView.setImageResource(question.imageId);
        this.questionTextView.setText(""+question.questionText+"");
        this.answer0Button.setText(""+question.answer0+"");
        this.answer1Button.setText(""+question.answer1+"");
        this.answer2Button.setText(""+question.answer2+"");
        this.answer3Button.setText(""+question.answer3+"");
    }
    // TODO 3-C: displayQuestionsRemaining(int questionRemaining) {...}
    void displayQuestionsRemaining(int questionRemaining)
    {
        this.questionRemainingTextView.setText(""+questionRemaining+"");
    }
    ...
    void onAnswerSelected(int answerSelected)
    {
        ...
        this.answer0Button.setText(currentQuestion.answer0);
        this.answer1Button.setText(currentQuestion.answer1);
        this.answer2Button.setText(currentQuestion.answer2);
        this.answer3Button.setText(currentQuestion.answer3);
